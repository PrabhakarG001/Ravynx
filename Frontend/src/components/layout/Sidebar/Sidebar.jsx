...
const navGroups = [
  ...
  },
  {
    title: "VERIFICATION",
    items: [
      { path: "/analysis", icon: HiOutlineCpuChip, label: "Analysis" },
      ...
      <>
        ...
        >
          ...
          <div className="sidebar-cls-7">
            {collapsed ? (
              /* Collapsed — show a centred icon button only */
              ...
              <div className="sidebar-cls-8">
                ...
                <input
                  ...
                  className="w-full h-9 bg-white border border-[#e3e8ee] rounded-md text-[13px] text-[#1a1f36] placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all pl-9 pr-8 cursor-text"
                />
                {!searchQuery && (
                  <div className="sidebar-cls-9">/</div>
                )}
              </div>
            )}
                      ...
                      <div key={path} className="sidebar-cls-21" ref={isNotif ? notifRef : null}>
                        ...
                        >
                          <div className="sidebar-cls-22">
                            <Icon className={`sidebar-nav-icon${isActive ? " sidebar-nav-icon--active" : ""}`}/>
